...
// # define INVITE_USER(user, target, channel) (user.getNickname() + " invited " + target.getNickname() + " to " + channel.getName())
...
# define MODE_SET_INVITE_ONLY(user, channel, modeType) (":" + user.getUserIdent() + " MODE " + channel + " " + modeType)
# define MODE_SET_TOPIC_RESTRICTED(user, channel, modeType) (":" + user.getUserIdent() + " MODE " + channel + " " + modeType)
# define MODE_SET_KEY_REQUIRED(user, channel, modeType) (":" + user.getUserIdent() + " MODE " + channel + " " + modeType)
# define MODE_SET_OPERATOR(user, channel, modeType) (":" + user.getUserIdent() + " MODE " + channel + " " + modeType)
# define MODE_SET_USER_LIMIT(user, channel, modeType) (":" + user.getUserIdent() + " MODE " + channel + " " + modeType)
...
# define ERR_USER_ALREADY_OPERATOR(user, channel, targetName) (":" + std::string(SERVER_NAME) + " 512 " + user.getNickname() + " " + channel + " " + targetName + " :is already channel operator")
...
# define ERR_CHANNEL_INVITE_ONLY(user, channel) (":" + std::string(SERVER_NAME) + " 473 " + user.getNickname() + " " + channel + " :Cannot join channel (+i)")
# define ERR_USER_NOT_IN_CHANNEL(user, channel) (":" + std::string(SERVER_NAME) + " 441 " + user.getNickname() + " " + channel + " :User isn't on that channel")
# define ERR_USER_IS_ALREADY_ON_CHANNEL(user, channel) (":" + std::string(SERVER_NAME) + " 443 " + user.getNickname() + channel + ":User is already on that channel")
